...
class ActualArtifacts(unittest.TestCase):
    ...
    def test_actual_corruptions(self):
        ...
        cases = [
          ...
          ('kernel/.config',replace(b'CONFIG_MUSB_PIO_ONLY=y',b'# CONFIG_MUSB_PIO_ONLY is not set')),
          ('kernel/.config',lambda b:b+b'\nCONFIG_USB_MUSB_DUAL_ROLE=y\n'),
          ('y2.dtb',replace(struct.pack('>III',0,32,8),struct.pack('>III',0,32,4))),
          ('y2.dtb',replace(b'peripheral\0',b'host\0\0\0\0\0\0\0')),
