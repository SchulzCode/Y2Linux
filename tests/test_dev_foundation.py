...
BUILD=Path(os.environ.get('Y2_ARTIFACT_TEST_ROOT',ROOT/'out/y2linux-production-build-v1-r4'))
class DevFoundation(unittest.TestCase):
    ...
    def test_dt_protects_emmc_and_reservations(self):
        ...
        check_dtb(data,size)
        for old,new in [(b'innioasis,y2-mmc\0',b'innioasis,y2-xxx\0'),
    ...
    def test_rescue_archive_and_bad_data(self):
        ...
        self.assertEqual(entries['init'][1],(ROOT/'initramfs/production/init').read_bytes())
