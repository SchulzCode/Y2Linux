...
def main():
    ...
    p.add_argument('--output',default='out/y2linux-m5-connectivity-06-build')
    ...
    versions={'release_version':'0.1.0-m5.connectivity.6','layout_version':1,'kernel_version':'6.18.0'+localversion,'rootfs_version':'2025.02.17-connectivity.6','data_schema_version':1,'y2player_version':None,'build_git_commit':commit}
