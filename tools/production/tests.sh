...
PYTHONPATH=/project/tests python3 -m unittest tests.test_power tests.test_charger tests.test_power_policy tests.test_offline_charging tests.test_power03 tests.test_connectivity -v
