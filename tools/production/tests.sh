...
python3 -m unittest tests.test_platform_contract tests.test_platform_storage_tools tests.test_platform_measurement tests.test_platform_power_contract tests.test_platform_network_time tests.test_platform_bluetooth -v
