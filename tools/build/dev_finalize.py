...
def main():
    p=argparse.ArgumentParser(description=__doc__);p.add_argument('root',type=Path);a=p.parse_args();root=a.root.resolve()
    ...
    shutil.copyfile(PROJECT/'docs/build/y2linux-dev-01-deployment.md',root/'DEPLOYMENT.md')
    ...
    metadata={'candidate':'Y2LINUX-DEV-01','analysis_checkpoint':'2efcdc1',
