...
| 6 | Signed staged root updates/recovery, reset/backup (#32/#33) | Implemented/host tested: signed staging/key policy/offline backup-write-readback/restore; reset/export; update ARM/fault checks passed; newer reset/export awaits final build | Interruption/recovery; automatic BOOTIMG writes excluded |
...
| 8 | Release/security/endurance/candidate (#32/#33) | ACTIVE: endurance/release tools, then fresh paired-source build and exact candidate receipts | Owner sessions A–G and qualified operating envelope |
